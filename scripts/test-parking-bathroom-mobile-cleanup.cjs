...
assert.match(parkingRepository, /mapSupabaseParking\(row, getParkingLocation\(row\.id\), universalParkingImage\)/);
...
assert.match(bathroomRepository, /mapSupabaseBathroom\(row, getBathroomLocation\(row\.id\), universalBathroomImage\)/);
