...
export function EventDetailsView({ event }: { event: EventLocation }) {
  ...
  return <SafeAreaView edges={['top']} style={styles.safeArea}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    ...
    <View style={styles.panel}>
      ...
      <DetailRow icon="calendar-outline" value={getEventDateLabel(event)} />
      <DetailRow icon="time-outline" value={getEventTimeLabel(event)} />
    ...
    {event.recurringNote ? <View style={styles.panel}><Text style={styles.panelTitle}>Additional dates</Text><Text style={styles.body}>{event.recurringNote}</Text></View> : null}
...
const styles = StyleSheet.create({
  ...
  featured: { ...typography.eyebrow }, heading: { ...typography.title }, panelTitle: { ...typography.heading },
