...
const customImageRow = parsePublishedBathroomRows([{ ...libraryInput, image_path: 'bathrooms/salem-public-library-restrooms/11111111-1111-4111-8111-111111111111.webp' }])[0];
assert.equal((mapSupabaseBathroom(customImageRow, undefined, 1, () => 'https://images.example/bathroom.webp').image as { uri: string }).uri, 'https://images.example/bathroom.webp');
assert.equal(parsePublishedBathroomRows([{ ...libraryInput, image_path: 'parking/salem-public-library-restrooms/11111111-1111-4111-8111-111111111111.webp' }])[0].image_path, null);
